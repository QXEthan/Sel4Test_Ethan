...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/c_traps.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/idle.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/kernel/thread.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/kernel/vspace.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_KERNEL_LOG_BUFFER */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/machine/capdl.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_DEBUG_BUILD */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/machine/debug.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/machine/fpu.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/machine/registerset.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/model/statedata.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ARM_BASE_CP14_SAVE_AND_RESTORE */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/64/object/objecttype.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/api/faults.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/armv/armv8-a/64/cache.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/armv/armv8-a/64/user_access.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/benchmark/benchmark.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/c_traps.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_ARM_HYPERVISOR_SUPPORT */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/kernel/boot.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/kernel/thread.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/machine/cache.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/machine/debug.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ARM_BASE_CP14_SAVE_AND_RESTORE */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/machine/errata.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/machine/gic_v2.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* End of CONFIG_ARM_HYPERVISOR_SUPPORT */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/machine/hardware.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/machine/io.c"
/*
...
#endif /* CONFIG_DEBUG_BUILD */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/machine/l2c_nop.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/object/interrupt.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/object/iospace.c"
/*
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/object/smc.c"
/*
...
#endif
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/object/smmu.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/object/tcb.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/object/vcpu.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/home/ethan/sel4test_ethan/kernel/src/arch/arm/smp/ipi.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_BENCHMARK_TRACK_UTILISATION */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/drivers/serial/pl011.c"
/*
 * Copyright 2016, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif  /* CONFIG_DEBUG_BUILD */
#line 1 "/home/ethan/sel4test_ethan/kernel/src/drivers/timer/generic_timer.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
